...
config :exmeal, ExmealWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "dg/zLymFFIgq3K8Pt6zbpppJ3m5xsyvDkC2F9tiUEdxrdOFk3qfjFMKyzX/85oxv",
  render_errors: [view: ExmealWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Exmeal.PubSub,
  live_view: [signing_salt: "rPBvMdfh"]
...
# Configure Ecto to generates UUID as binary_id
